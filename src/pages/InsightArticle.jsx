            ...
            {article.sections.map((section, i) => (
              <div key={i}>
                <div className="flex items-start gap-4 mb-3">
                  <span className="text-[10px] font-extrabold tabular-nums text-[var(--pqube-cyan)] pt-1.5">
      ...
      <section className="section-padding bg-[var(--pqube-gray-50)]">
        <div className="container-page">
          <div className="text-center mb-10">
            <ShinyText text="More Reading" color="#29ABE2" shineColor="#ffffff" speed={3} spread={120} className="inline-block text-xs font-semibold uppercase tracking-[0.15em] mb-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {more.map((m) => (
              <Link
                key={m.id}
                to={m.link}
                className="group flex flex-col bg-white border border-[var(--pqube-gray-200)] rounded-2xl overflow-hidden hover:border-[var(--pqube-blue)]/40 hover:shadow-lg transition-all"
              >
                ...
                <div className="p-5">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[var(--pqube-blue)] mt-3">
